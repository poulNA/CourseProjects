...
public final class Client {
  ...
  public void getCourse(
      @NonNull final Summary summary, @NonNull final Client.CourseClientCallbacks callbacks) {
    String url =
    ...
    StringRequest ratingRequest =
        new StringRequest(
          ...
          public byte[] getBody() throws AuthFailureError {
            String rating1 = "";
            try {
              rating1 = objectMapper.writeValueAsString(rating);
              return rating1.getBytes();
            } catch (JsonProcessingException e) {
              e.printStackTrace();
            }
            return new byte[0];
